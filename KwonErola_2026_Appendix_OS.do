...
use KwonJani_2026_CombinedData_cleaned, clear /// See the Main Analysis file to get this data
...
estout a11 a12 a13, cells(b(star fmt(3)) se(par fmt(3))) starl( * 0.05 ** 0.010 *** 0.001) nobaselevels nolabel stats(N aic, labels ("No. of Obs." "AIC") fmt(0 3))
...
estout  a21 a22 a23, cells(b(star fmt(3)) se(par fmt(3))) starl(* 0.05 ** 0.010 *** 0.001) nobaselevels nolabel stats(N  aic, labels ("No. of Obs." "AIC") fmt(0 3))
...
estout a31 a32 a33, cells(b(star fmt(3)) se(par fmt(3))) starl(* 0.05 ** 0.010 *** 0.001) nobaselevels nolabel stats(N  aic, labels ("No. of Obs." "AIC") fmt(0 3))
